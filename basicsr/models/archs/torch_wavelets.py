...
class IDWT_2D(nn.Module):
    def __init__(self, wave):
        ...
        w_lh = rec_hi.unsqueeze(0) * rec_lo.unsqueeze(1)  # lo along rows, hi along cols
        w_hl = rec_lo.unsqueeze(0) * rec_hi.unsqueeze(1)  # hi along rows, lo along cols
...
class DWT_2D(nn.Module):
    def __init__(self, wave):
        ...
        w_lh = dec_hi.unsqueeze(0) * dec_lo.unsqueeze(1)  # lo along rows, hi along cols
        w_hl = dec_lo.unsqueeze(0) * dec_hi.unsqueeze(1)  # hi along rows, lo along cols
